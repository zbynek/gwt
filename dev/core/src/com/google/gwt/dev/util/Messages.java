...
public class Messages {
  ...
  public static final Message0 HINT_CHECK_INHERIT_CORE = new Message0(
      TreeLogger.ERROR,
      "Hint: Check that your module inherits 'com.google.gwt.core.Core' either directly" +
          " or indirectly (most often by inheriting module 'com.google.gwt.user.User')");
  public static final Message0 HINT_CHECK_INHERIT_USER = new Message0(
      TreeLogger.ERROR,
      "Hint: Check that your module inherits 'com.google.gwt.user.User'" +
          " either directly or indirectly");
  public static final Message0 HINT_CHECK_MODULE_INHERITANCE = new Message0(
      TreeLogger.ERROR,
      "Hint: Check the inheritance chain from your module; it may not be inheriting" +
          " a required module or a module may not be adding its source path entries properly");
  public static final Message0 HINT_CHECK_MODULE_NONCLIENT_SOURCE_DECL = new Message0(
      TreeLogger.ERROR,
      "Hint: Your source appears not to live underneath a subpackage called 'client';" +
          " no problem, but you'll need to use the <source> directive in your module" +
