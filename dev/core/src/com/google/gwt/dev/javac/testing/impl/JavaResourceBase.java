...
public class JavaResourceBase {
  ...
  public static MockJavaResource[] getStandardResources() {
    return new MockJavaResource[] {
        ...
        JAVASCRIPTOBJECT, LIST, LONG, MAP, NO_CLASS_DEF_FOUND_ERROR,
        NUMBER, OBJECT, OBJECTMETHODS,
  ...
  public static List<MockJavaResource> getReflectionResources() {
    return List.of(
            METHOD_HANDLE, METHOD_HANDLES, METHOD_TYPE, STRING_CONCAT_FACTORY);
  }
