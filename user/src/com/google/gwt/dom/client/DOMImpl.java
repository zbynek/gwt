...
abstract class DOMImpl {
  ...
  public int getAbsoluteLeft(Element elem) {
    return getAbsoluteLeftImpl(getDocumentScrollingElement(elem.getOwnerDocument()), elem);
  }

  public int getAbsoluteTop(Element elem) {
    return getAbsoluteTopImpl(getDocumentScrollingElement(elem.getOwnerDocument()), elem);
  }
  ...
  public int getScrollLeft(Document doc) {
    return getDocumentScrollingElement(doc).getScrollLeft();
  }
  ...
  public int getScrollTop(Document doc) {
    return getDocumentScrollingElement(doc).getScrollTop();
  }
  ...
  public void setScrollLeft(Document doc, int left) {
    getDocumentScrollingElement(doc).setScrollLeft(left);
  }
  ...
  public void setScrollTop(Document doc, int top) {
    getDocumentScrollingElement(doc).setScrollTop(top);
  }
  ...
  protected Element ensureDocumentScrollingElement(Document document) {
  ...
  protected native int getAbsoluteLeftImpl(Element viewport, Element elem) /*-{
    return (elem.getBoundingClientRect().left + viewport.scrollLeft) | 0;
  }-*/;

  protected native int getAbsoluteTopImpl(Element viewport, Element elem) /*-{
